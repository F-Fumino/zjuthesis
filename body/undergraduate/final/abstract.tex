...
\noindent\textbf{关键词：}GPU 驱动渲染；Vulkan；工业场景；流式加载；细节层次（LOD）
...
\noindent\textbf{Key words：}GPU-driven rendering、Vulkan、Industrial scene、Streaming、Levels of Detail (LOD)