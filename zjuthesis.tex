...
\documentclass[
    ...
    % Title
    Title           = {GPU驱动的复杂工业场景的高效处理与实时渲染},
    TitleEng        = {{GPU-Driven Efficient Processing and Real-Time Rendering of Complicated Industrial Scenes}}
]{zjuthesis}

\usepackage{subcaption}
\usepackage{amsmath}
\usepackage{mathtools} % 如果有其他数学包，放在前面

\setlength{\abovedisplayskip}{12pt}   % 上间距
\setlength{\belowdisplayskip}{12pt}   % 下间距
\setlength{\abovedisplayshortskip}{12pt} % 短上
\setlength{\belowdisplayshortskip}{12pt} % 短下
